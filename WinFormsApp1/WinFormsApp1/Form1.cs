...
namespace WinFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void ChangeText()
        {
            while (true)
            {
                _consumer = new Consumer(_queueNameBack);
        ...
        private void SetText(string number)
        {
            ...
            if (number != null)
            {
                listBox1.Items.Add("KMS Base Client: " + number);
            }
        }
        ...
        private void textBox1_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                if (sender is TextBox)
                {
                    ...
                    _publisher = new Publisher(_queueName, txb.Text);
                    listBox1.Items.Add("KMS Customer Client: " + txb.Text);
                    textBox1.Text = "";
                }
            }
        }
